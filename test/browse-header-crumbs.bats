...
@test "'browse <notebook>:<folder-id>/<folder-id>/ --add' displays header crumbs with '+' unlinked." {
  ...
  printf "%s\\n" "${output}" | grep -q \
"<nav class=\"header-crumbs\"><a href=\"//localhost:6789/?--per-page=.*&--columns=.*\"><span class=\"muted\">❯</span>nb</a> <span class=\"muted\">·</span> "

  printf "%s\\n" "${output}" | grep -q \
" <span class=\"muted\">·</span> <a href=\"//localhost:6789/home:?--per-page=.*&--columns=.*\">home</a> <span class=\"muted\">:</span> "

  printf "%s\\n" "${output}" | grep -q \
" <span class=\"muted\">:</span> <a href=\"//localhost:6789/home:1/?--per-page=.*&--columns=.*\">Example Folder</a> <span class=\"muted\">/</span> "

  printf "%s\\n" "${output}" | grep -q \
" <span class=\"muted\">/</span> <a href=\"//localhost:6789/home:1/1/?--per-page=.*&--columns=.*\">Sample Folder</a> <span class=\"muted\">/</span> "

  printf "%s\\n" "${output}" | grep -q \
" <span class=\"muted\">/</span> <span class=\"muted\">+</span></nav>"
...
@test "'browse --edit' with .odt file does not display edit link in header crumbs." {
  ...
  printf "%s\\n" "${output}" | grep     -q \
"<a.* href=\"//localhost:6789/?--per-page=.*&--columns=.*\"><span class=\"muted\">❯</span>nb</a> <span class=\"muted\">·</span> "

  printf "%s\\n" "${output}" | grep     -q \
" <span class=\"muted\">·</span> <a.* href=\"//localhost:6789/home:?--per-page=.*&--columns=.*\">home</a> <span class=\"muted\">:</span> "

  printf "%s\\n" "${output}" | grep     -q \
" <span class=\"muted\">:</span> <a.* href=\"//localhost:6789/home:2/?--per-page=.*&--columns=.*\">Example Folder</a> <span class=\"muted\">/</span> "
...
" <span class=\"muted\">/</span> <a href=\"//localhost:6789/home:1/1/?--per-page=.*&--columns=.*\">Sample Folder</a> <span class=\"muted\">/</span> "
  ...
  printf "%s\\n" "${output}" | grep -q \
"</span> <a href=\"//localhost:6789/home:1/1/1?--per-page=.*&--columns=.*\">1</a> <span class=\"muted\">·</span> "
...
"<span class=\"muted\">·</span> <span class=\"muted\">editing</span> <span class=\"muted\">·</span> <a href=\"//local"
  ...
  printf "%s\\n" "${output}" | grep -q \
"host:6789/home:1/1/1?--per-page=.*&--columns=.*&--delete\">-</a> <span class=\"muted\">\|</span> <a "
...
@test "'browse <notebook>:<folder-id>/<folder-id>/<file-id>' with local notebook displays header crumbs with id with file." {
  ...
  printf "%s\\n" "${output}" | grep -q \
"<nav class=\"header-crumbs\"><a href=\"//localhost:6789/${_expected_params}\"><span class=\"muted\">❯</span>nb</a> <span class=\"muted\">·</span> "
...
"</span> <a.* href=\"//localhost:6789/--original/home/File One.md\">↓</a>"
  ...
  printf "%s\\n" "${output}" | grep -q \
" <a href=\"//localhost:6789/home:1?--per-page=.*&--columns=.*&--edit\">edit</a> <span class=\"muted\">\|</span> <a "
...
"</span> <a.* href=\"//localhost:6789/--original/home/Example Folder/Sample Folder/File One.md\">↓</a>"
  ...
  printf "%s\\n" "${output}" | grep -q \
"<a href=\"//localhost:6789/home:1/1/1?--per-page=.*&--columns=.*&--edit\">edit</a> <span class=\"muted\">\|</span> <a "
...
"</span> <a.* href=\"//localhost:6789/--original/home/Example Folder/File One.md\">↓</a>"
  ...
  printf "%s\\n" "${output}" | grep -q \
"<a href=\"//localhost:6789/home:1/1?--per-page=.*&--columns=.*&--edit\">edit</a> <span class=\"muted\">|</span> <a "
...
" <span class=\"muted\">:</span> <a href=\"//localhost:6789/home:1/?--per-page=.*&--columns=.*\">Example Folder</a> <span class=\"muted\">/</span> "
  ...
  printf "%s\\n" "${output}" | grep -q \
" <span class=\"muted\">/</span> <a href=\"//localhost:6789/home:1/1/?--per-page=.*&--columns=.*\">Sample Folder</a> <span class=\"muted\">/</span> <a "
...
@test "'browse <notebook-path>/<folder>/<filename>' displays header crumbs with folder and id for file." {
  ...
  printf "%s\\n" "${output}" | grep -q \
"<nav class=\"header-crumbs\"><a href=\"//localhost:6789/?--per-page.*\"><span class=\"muted\">❯</span>nb</a> <span class=\"muted\">·</span> "
...
" <span class=\"muted\">·</span> <a href=\"//localhost:6789/home:?--per-page=.*&--columns=.*\">home</a> <span class=\"muted\">:</span> "
  ...
  printf "%s\\n" "${output}" | grep -q \
" <span class=\"muted\">:</span> <a href=\"//localhost:6789/home:1/?--per-page=.*&--columns=.*\">Example Folder</a> <span class=\"muted\">/</span> <a "
