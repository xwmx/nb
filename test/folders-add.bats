...
@test "'add <folder>/ <filename>' creates new file with <filename> in new <folder>." {
  {
    "${_NB}" init
...
@test "'add <folder>/ <folder-name> --type folder' creates new folder with <folder-name> in new <folder>." {
  {
    "${_NB}" init
